...
<div class="pub-card">
  <div class="pub-number">
    5<br>
    <a href="https://ieeexplore.ieee.org/abstract/document/9707598" target="_blank">paper URL ↗</a>
  </div>

  <div class="pub-info">
    <h3>Remotely actuated optothermal robotic microjoints based on spiral bimaterial design</h3>
    <p class="authors">B. Ahmad, A. Barbot, G. Ulliac, and A. Bolopion</p>
    <p class="journal"><em>IEEE/ASME Transactions on Mechatronics</em>, vol. 27, no. 5, pp. 4090–4100, 2022.</p>
  </div>

  <div class="pub-image">
    <img src="images/TMECH2022.png">
  </div>
</div>
...
<div class="pub-card">
  <div class="pub-number">
    6<br>
    <a href="https://www.mdpi.com/2072-666X/12/12/1487" target="_blank">paper URL ↗</a>
  </div>

  <div class="pub-info">
    <h3>Laser actuated microgripper using optimized chevron-shaped actuator</h3>
    <p class="authors">B. Ahmad*, H. Chambon*, P. Tissier*, and A. Bolopion  (*Equal first author)</p> 
    <p class="journal"><em>Micromachines</em>, vol. 12, no. 12, p. 1487, 2021.</p>
  </div>
...
<div class="pub-card">
  <div class="pub-number">
    7<br>
    <a href="https://ieeexplore.ieee.org/abstract/document/9462544" target="_blank">paper URL ↗</a>
  </div>

  <div class="pub-info">
    <h3>Mobile microrobots for in vitro biomedical applications: a survey</h3>
    <p class="authors">B. Ahmad, M. Gauthier, G. J. Laurent, and A. Bolopion</p>
    <p class="journal"><em>IEEE Transactions on Robotics</em>, vol. 38, no. 1, pp. 646–663, 2021.</p>
  </div>

  <div class="pub-image">
    <img src="images/TRO2021.png">
  </div>
</div>
...
<div class="pub-card">
  <div class="pub-number">
    8<br>
    <a href="https://ieeexplore.ieee.org/abstract/document/8988211" target="_blank">paper URL ↗</a>
  </div>

  <div class="pub-info">
    <h3>Dynamic response of swimming Paramecium induced by local stimulation using a threadlike-microtool</h3>
    <p class="authors">B. Ahmad, H. Maeda, and T. Kawahara</p>
    <p class="journal"><em>IEEE Robotics and Automation Letters</em>, vol. 5, no. 2, pp. 2570–2577, 2020.</p>
  </div>

  <div class="pub-image">
    <img src="images/RAL2020.png">
  </div>
</div>
...
<div class="pub-card">
  <div class="pub-number">
    9<br>
    <a href="https://www.mdpi.com/2076-3417/9/8/1560" target="_blank">paper URL ↗</a>
  </div>

  <div class="pub-info">
    <h3>Three-motorized-stage cyclic stretching system for cell monitoring based on chamber local displacement waveform</h3>
    <p class="authors">W. Huang, S. Zhang, B. Ahmad, and T. Kawahara</p>
    <p class="journal"><em>Applied Sciences</em>, vol. 9, no. 8, p. 1560, 2019.</p>
  </div>
...
<div class="pub-card">
  <div class="pub-number">
    10<br>
    <a href="https://www.mdpi.com/2072-666X/8/10/295" target="_blank">paper URL ↗</a>
  </div>

  <div class="pub-info">
    <h3>Microrobotic platform for single motile microorganism investigation</h3>
    <p class="authors">B. Ahmad, H. Maeda, T. Kawahara, and F. Arai</p>
    <p class="journal"><em>Micromachines</em>, vol. 8, no. 10, p. 295, 2017.</p>
  </div>

  <div class="pub-image">
    <img src="images/Micromachines2017.png">
  </div>
</div>
```
